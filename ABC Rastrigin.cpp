...
#define NP 100 /* The number of colony size (employed bees+onlooker bees)*/
...
#define maxCycle 100 /*The number of cycles for foraging {a stopping criteria}*/

/* Problem specific variables*/
#define D 5 /*The number of parameters of the problem to be optimized*/
#define lb -15 /*lower bound of the parameters. */
...
return top;
 ...
 double Ackley(double x[D])
 {
	...
	return (-1.0)*20.0 * exp((-1.0) * 0.20 * sqrt((1.0/D) * s1)) - exp((1.0/D) * s2) + 2.71 + 20;
 }
